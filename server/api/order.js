...
async function orderLookup(req, res) {
  ...
  const result = await query(
    `select o.id, o.status, o.payment_status, o.total_amount, o.discount_code, o.discount_amount, o.shipping_fee, o.carrier, o.tracking_code, o.created_at, o.updated_at,
