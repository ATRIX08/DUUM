...
const adminObservability = require('./admin-observability');
...
function routeApi(req, res) {
  ...
  if (pathname === '/api/product-meta') return productMeta(req, res);
  ...
  if (pathname === '/api/admin-observability') return adminObservability(req, res);
